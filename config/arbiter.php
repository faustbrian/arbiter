...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Determines the type of primary key used for all Arbiter models.
    | Supported values: 'id' (auto-increment), 'uuid', 'ulid'
    |
    */

    'primary_key_type' => env('ARBITER_PRIMARY_KEY_TYPE', 'id'),
    ...
    |--------------------------------------------------------------------------
    |
    | Enable or disable database storage for policies. When false, only
    | file-based repositories (JSON, YAML, Array) will be available.
    |
    */

    'use_database' => env('ARBITER_USE_DATABASE', false),
    ...
    */
    ...
    'models' => [
        'policy' => env('ARBITER_POLICY_MODEL'),
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Customize table names for Arbiter models. This allows you to integrate
    | Arbiter into existing database schemas without conflicts.
    |
    */

    'tables' => [
        'policies' => env('ARBITER_POLICIES_TABLE', 'policies'),
    ],
